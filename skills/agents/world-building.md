...
### 英雄之旅阶段映射（来源：坎贝尔《千面英雄》）
- **启程阶段**：新手村/安全区 -> 有限地图 -> 明确的目标方向
- **启蒙阶段**：地图扩展 -> 新势力引入 -> 力量体系突破 -> 更高层世界入口
- **归来阶段**：世界真相揭示 -> 终极规则 -> 力量体系归位

### 设定即冲突原则（来源：马斯《Writing the Breakout Novel》）
每个设定元素都应该是冲突的源头。检验标准：
- 这个地理特征会不会让两派打起来？
- 这个力量体系会不会造成阶级对立？
- 这条规则会不会让主角无法达成目标？
- 回答了"否" -> 可能是冗余设定，建议重新设计

### 象征网络（来源：特鲁比《The Anatomy of Story》）
每隔50-100章回顾全局，给核心设定分配象征意义：
- 自然元素（山/海/火/冰）-> 映射角色内心状态
- 建筑/城市 -> 映射势力格局
- 神器/法宝 -> 映射力量与责任
